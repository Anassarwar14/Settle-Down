  ...
  return (
    <div>
      ...
      <section style={{background: `url("https://images.pexels.com/photos/1029606/pexels-photo-1029606.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2") center/contain no-repeat`, backgroundPosition: ''}} className='px-4 overflow-hidden'>
        ...
        <div ref={featuredRef} className='bg-white p-8 rounded-3xl fading-up'>
        ...
        <div className='bg-white p-8 rounded-3xl mt-7 fading-up'>
          <div className='flex justify-between items-center sm:items-baseline'>
      ...
      <section className='mx-auto max-w-7xl mt-2 mb-4 sm:mt-10 sm:mb-20'>
        <div className='grid sm:grid-cols-2 p-4 sm:gap-10 relative'>
          <div className='sm:p-8 flex flex-col gap-10'>
            ...
            <p className='text-stone-700 max-sm:mix-blend-multiply'>
          ...
          <img className='rounded-t-3xl rounded-b-xl absolute left-40 sm:left-80 sm:top-1 shadow-lg h-[40vh] w-60 sm:h-[69vh] -z-10 sm:w-[100vh]' src="https://img.freepik.com/free-vector/blurred-background-green-color_1035-3316.jpg?t=st=1724696789~exp=1724700389~hmac=3a12b85cef511fe13289e412e81e1f1edfd3227ef35a63aa90c697582f2cf6b3&w=740" alt="" />
        </div>
      </section>

      <section style={{background: 'url("") left/contain no-repeat'}} className='max-sm:min-h-[80vh] '>
      ...
      <section className='my-10 sm:my-20 max-w-5xl mx-auto h-[70vh] py-10 max-sm:w-96 max-sm:px-5 flex flex-col items-center justify-around bg-gray-200 rounded-lg'>
        <h1 className='text-5xl'>How <span className='text-rose-600'>confident</span> are you to sell your property?</h1>
