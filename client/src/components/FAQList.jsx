...
const FAQList = () => {
  const faqs = [
    ...
    { question: 'How can I schedule a property viewing?', answer: 'Choose the property best suited to your needs, and select the "Show Contacts" button in the brief overview on the bottom-right of the listing. This will open a contact landlord form, enter your name and message in the input and an email would be automatically sent to the landlord.' },
