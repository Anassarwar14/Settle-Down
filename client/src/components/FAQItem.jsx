...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="mb-4">
      <button
        onClick={toggleOpen}
        className={`${isOpen && 'text-teal-600'} group mt-2 font-light text-md sm:text-2xl max-sm:gap-2 text-left w-full flex justify-between items-center rounded-lg py-8 px-1 hover:bg-teal-600 hover:text-zinc-50 transition`}
      >
