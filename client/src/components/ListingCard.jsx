...
import { PiBathtubThin, PiBedThin } from 'react-icons/pi';
import { PiArmchairFill } from "react-icons/pi";
import { CiParking1 } from "react-icons/ci";

const ListingCard = ({listing}) => {
  return (
    <article className='group flex flex-col justify-between h-full rounded-2xl shadow-lg hover:shadow-xl hover:shadow-gray-300 shadow-gray-200 p-3 sm:p-3 border max-sm:border-2 '>
